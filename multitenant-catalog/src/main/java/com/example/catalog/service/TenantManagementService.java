...
public class TenantManagementService {
    ...
    @Autowired
    public TenantManagementService(EncryptionService encryptionService,
...
//        jdbcTemplate.execute((StatementCallback<Boolean>) stmt -> stmt.execute("CREATE SCHEMA IF NOT EXISTS " + db + "." + db));
    }
